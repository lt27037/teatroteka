<header class="header">
    <div class="header__mobile">
        <img src="assets/img/logo.png" alt="logo" class="header__mobile__logo">
        <button class="header__search">Szukaj</button>
        <span class="header__list__button" tabindex="1" style="display: flex;">
